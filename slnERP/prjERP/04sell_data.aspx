...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:DetailsView ID="DetailsView1" runat="server" Height="50px" Width="500px" AutoGenerateRows="False" DataKeyNames="sid" DataSourceID="sell01_DV" DefaultMode="Insert" OnItemInserted="DetailsView1_ItemInserted">
        <Fields>
            ...
            <asp:TemplateField HeaderText="銷貨單號" SortExpression="order_id">
                ...
                <InsertItemTemplate>
                    <asp:TextBox ID="TextBox1" runat="server" MaxLength="50" Text='<%# Bind("order_id") %>'></asp:TextBox>
            ...
            <asp:TemplateField HeaderText="銷貨日期" SortExpression="order_date">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("order_date") %>'></asp:TextBox>
                </EditItemTemplate>
                <InsertItemTemplate>
                ...
                <ItemTemplate>
                    <asp:Label ID="Label1" runat="server" Text='<%# Bind("order_date") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="銷貨商名稱" SortExpression="dealer_name">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox3" runat="server" Text='<%# Bind("dealer_name") %>'></asp:TextBox>
                </EditItemTemplate>
                <InsertItemTemplate>
                ...
                <ItemTemplate>
                    <asp:Label ID="Label3" runat="server" Text='<%# Bind("dealer_name") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="運費" SortExpression="freight">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox8" runat="server" Text='<%# Bind("freight") %>'></asp:TextBox>
                </EditItemTemplate>
                <InsertItemTemplate>
                    <asp:TextBox ID="TextBox3" runat="server" MaxLength="21" Text='<%# Bind("freight") %>'></asp:TextBox>
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="TextBox3" ErrorMessage="*格式錯誤" ValidationExpression="^[0-9]+(.[0-9]{2})?$" ValidationGroup="DV_sell01"></asp:RegularExpressionValidator>
                </InsertItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label8" runat="server" Text='<%# Bind("freight") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="總金額" SortExpression="total_money">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox9" runat="server" Text='<%# Bind("total_money") %>'></asp:TextBox>
                </EditItemTemplate>
                <InsertItemTemplate>
                    <asp:TextBox ID="TextBox4" runat="server" MaxLength="21" Text='<%# Bind("total_money") %>'></asp:TextBox>
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="TextBox4" ErrorMessage="*格式錯誤" ValidationExpression="^[0-9]+(.[0-9]{2})?$" ValidationGroup="DV_sell01"></asp:RegularExpressionValidator>
                </InsertItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label9" runat="server" Text='<%# Bind("total_money") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="課稅別" SortExpression="tax">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox6" runat="server" Text='<%# Bind("tax") %>'></asp:TextBox>
                </EditItemTemplate>
                <InsertItemTemplate>
                ...
                <ItemTemplate>
                    <asp:Label ID="Label6" runat="server" Text='<%# Bind("tax") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="發票號碼" SortExpression="invoice_num">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox10" runat="server" Text='<%# Bind("invoice_num") %>'></asp:TextBox>
                </EditItemTemplate>
                <InsertItemTemplate>
                ...
                <ItemTemplate>
                    <asp:Label ID="Label10" runat="server" Text='<%# Bind("invoice_num") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
    ...
    <asp:SqlDataSource ID="sell01_DV" runat="server" ConnectionString="<%$ ConnectionStrings:ezioConnectionString %>" 
        DeleteCommand="DELETE FROM [Sell_data1] WHERE [sid] = @sid" 
        InsertCommand="INSERT INTO [Sell_data1] ([order_id], [order_date], [staff], [dealer_name], [freight], [address], [total_money], [payway], [invoice_style], [tax], [invoice_num], [remark]) VALUES (@order_id, @order_date, @staff, @dealer_name, @freight, @address, @total_money, @payway, @invoice_style, @tax, @invoice_num, @remark)" 
        SelectCommand="SELECT * FROM [Sell_data1]" 
        UpdateCommand="UPDATE [Sell_data1] SET [order_id] = @order_id, [order_date] = @order_date, [staff] = @staff, [dealer_name] = @dealer_name, [freight] = @freight, [address] = @address, [total_money] = @total_money, [payway] = @payway, [invoice_style] = @invoice_style, [tax] = @tax, [invoice_num] = @invoice_num, [remark] = @remark WHERE [sid] = @sid">
        <DeleteParameters>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="sid" DataSourceID="sell01_GV">
        <Columns>
            <asp:TemplateField ShowHeader="False">
                <EditItemTemplate>
            ...
            <asp:TemplateField HeaderText="銷貨單號" SortExpression="order_id">
                ...
                <ItemTemplate>
                    <asp:Label ID="Label6" runat="server" Text='<%# Bind("order_id") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="銷貨日期" SortExpression="order_date">
                <EditItemTemplate>
            ...
            <asp:TemplateField HeaderText="運費" SortExpression="freight">
                <EditItemTemplate>
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="TextBox4" ErrorMessage="*格式錯誤" ValidationExpression="^[0-9]+(.[0-9]{2})?$" ValidationGroup="GV_sell01"></asp:RegularExpressionValidator>
                </EditItemTemplate>
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="總金額" SortExpression="total_money">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox5" runat="server" MaxLength="21" Text='<%# Bind("total_money") %>'></asp:TextBox>
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ControlToValidate="TextBox5" ErrorMessage="*格式錯誤" ValidationExpression="^[0-9]+(.[0-9]{2})?$" ValidationGroup="GV_sell01"></asp:RegularExpressionValidator>
                </EditItemTemplate>
                <ItemTemplate>
...
<ItemTemplate>
    ...
    <asp:DetailsView ID="DetailsView2" runat="server" AutoGenerateRows="False" DataKeyNames="sid" DataSourceID="sell02_DV" DefaultMode="Insert" Height="50px" Width="450px" OnItemInserted="DetailsView2_ItemInserted">
        <Fields>
            ...
            <asp:TemplateField HeaderText="銷貨單號" SortExpression="order_id">                
                <InsertItemTemplate>
                    <asp:DropDownList ID="DropDownList6" runat="server" DataSourceID="s01_order" DataTextField="order_id" DataValueField="sid" SelectedValue='<%# Bind("order_id") %>'>
                    </asp:DropDownList>
                </InsertItemTemplate>                
            </asp:TemplateField>
    ...
    <asp:SqlDataSource ID="sell02_DV" runat="server" ConnectionString="<%$ ConnectionStrings:ezioConnectionString %>" DeleteCommand="DELETE FROM [Sell_data2] WHERE [sid] = @sid" InsertCommand="INSERT INTO [Sell_data2] ([order_id], [item_name], [sell_quantity]) VALUES (@order_id, @item_name, @sell_quantity)" SelectCommand="SELECT * FROM [Sell_data2]" UpdateCommand="UPDATE [Sell_data2] SET [order_id] = @order_id, [item_name] = @item_name, [sell_quantity] = @sell_quantity WHERE [sid] = @sid">
        <DeleteParameters>
            <asp:Parameter Name="sid" Type="Int32" />
        </DeleteParameters>
        <InsertParameters>
    ...
    <asp:SqlDataSource ID="s01_order" runat="server" ConnectionString="<%$ ConnectionStrings:ezioConnectionString %>" SelectCommand="SELECT [sid], [order_id] FROM [Sell_data1]"></asp:SqlDataSource>
    ...
    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataKeyNames="sid" DataSourceID="sell02_GV">
        <Columns>
            ...
            <asp:TemplateField HeaderText="銷貨單號" SortExpression="order_id">
                <EditItemTemplate>
                    <asp:DropDownList ID="DropDownList8" runat="server" DataSourceID="s01_order" DataTextField="order_id" DataValueField="sid" SelectedValue='<%# Bind("order_id") %>'>
                    </asp:DropDownList>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label2" runat="server" Text='<%# Eval("order_id1") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:BoundField DataField="order_id1" HeaderText="銷貨單號" SortExpression="order_id1" Visible="False" />
            <asp:TemplateField HeaderText="商品名稱" SortExpression="item_name">
                <EditItemTemplate>
                    <asp:DropDownList ID="DropDownList9" runat="server" DataSourceID="item" DataTextField="Item_Name" DataValueField="Item_id" SelectedValue='<%# Bind("item_name") %>'>
                    </asp:DropDownList>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label1" runat="server" Text='<%# Eval("item_name1") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:BoundField DataField="item_name1" HeaderText="商品名稱" SortExpression="item_name1" Visible="False" />
            <asp:TemplateField HeaderText="銷貨數量" SortExpression="sell_quantity">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox1" runat="server" MaxLength="8" Text='<%# Bind("sell_quantity") %>'></asp:TextBox>
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator8" runat="server" ControlToValidate="TextBox1" ErrorMessage="*數量不得為0" ValidationExpression="^\+?[1-9]+[0-9]*$" ValidationGroup="GV_sell02"></asp:RegularExpressionValidator>
                </EditItemTemplate>
                <ItemTemplate>
    ...
    <asp:SqlDataSource ID="sell02_GV" runat="server" ConnectionString="<%$ ConnectionStrings:ezioConnectionString %>" 
        ...
        SelectCommand="select a.*,b.order_id,c.item_name from Sell_data2 a
