        ...
        <Fields>
            ...
            <asp:TemplateField HeaderText="員工手機" SortExpression="staff_cellphone">                
                <InsertItemTemplate>
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator8" runat="server" ControlToValidate="TextBox5" ErrorMessage="*格式錯誤，除國際碼+號外其餘請輸入純數字" ValidationExpression="(\(\d{3}\)|\d{3}-)?\d{8}" ValidationGroup="DV_IIF"></asp:RegularExpressionValidator>
                </InsertItemTemplate>                
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="員工密碼" SortExpression="staff_pwd">                
                <InsertItemTemplate>
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="TextBox8" ErrorMessage="*密碼格式有誤，不允許特殊符號、數字、英文字母以外的字元輸入、密碼長度4到50個字元" ValidationExpression="^(?!.*[^\x21-\x7e])(?=.{4,}).*$" ValidationGroup="DV_IIF"></asp:RegularExpressionValidator>
                    <br />
                </InsertItemTemplate>                
            </asp:TemplateField>
